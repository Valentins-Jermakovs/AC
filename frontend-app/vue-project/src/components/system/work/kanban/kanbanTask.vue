<template>
  <div class="w-full bg-base-100 rounded-box p-1 border border-base-300">
    ...
    <div class="flex flex-col items-center">
      ...
      <div class="w-full p-1"><p>{{ task.description }}</p></div>
    </div>

    <!-- BaseDialogs -->
    <BaseDialog v-model="updateModal" title="Update Task" confirmText="Save" cancelText="Cancel" @confirm="confirmUpdateTask">
      <div class="w-full flex flex-col gap-2">
        <input type="text" class="input w-full mb-2" v-model="newTaskTitle" placeholder="Task title" />
        <textarea class="input w-full" v-model="newTaskDescription" placeholder="Task description"></textarea>
      </div>
    </BaseDialog>

    <BaseDialog v-model="moveInStageModal" title="Move Task in Stage" confirmText="Move" cancelText="Cancel" @confirm="confirmMoveInStage">
      <div class="w-full flex flex-col gap-2">
    ...
    <BaseDialog v-model="moveBetweenStagesModal" title="Move Task to Another Stage" confirmText="Move" cancelText="Cancel" @confirm="confirmMoveBetweenStages">
      <div class="w-full flex flex-col gap-2">
    ...
    <BaseDialog v-model="deleteModal" title="Delete Task" confirmText="Delete" cancelText="Cancel" @confirm="confirmDeleteTask">
