<template>
  ...
  <form action="" class="flex flex-col gap-5">
    <div class="form-control flex flex-col gap-2">
      ...
      <input type="email" placeholder="test@example.com" class="input input-bordered w-full" />
    </div>
    <div class="form-control flex flex-col gap-2">
      <label class="label">
        <span class="label-text">{{ $t('common.username') }}</span>
      </label>
      <input type="text" placeholder="testuser" class="input input-bordered w-full" />
    </div>
    <div class="form-control flex flex-col gap-2">
      <label class="label">
  ...
  <div class="flex mt-6">
    <button class="btn btn-primary flex-1">{{ $t('common.register') }}</button>
  </div>
  <!-- google auth button -->
  <div class="flex mt-6">
