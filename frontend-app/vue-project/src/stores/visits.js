...
export const useVisitsStore = defineStore('visits', {
    ...
    actions: {
        async registerVisit() {
            ...
            try {
                const response = await api.post(API_ENDPOINTS.REGISTER_VISIT, {}, {
        ...
        async startSession() {
            ...
            try {
                const response = await api.post(API_ENDPOINTS.START_SESSION, {}, {
                    headers: { Authorization: `Bearer ${authStore.accessToken}` },
                })
        ...
        async endSession() {
            ...
            try {
                const response = await api.post(API_ENDPOINTS.END_SESSION, {}, {
                    headers: { Authorization: `Bearer ${authStore.accessToken}` },
                })
