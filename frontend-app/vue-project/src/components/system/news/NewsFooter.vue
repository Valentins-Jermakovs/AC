<template>
    ...
    <div
        ...
        <!-- LIMIT -->
        <div>
            <select class="select select-bordered w-full sm:w-24" v-model="newsStore.meta.limit"
        ...
        <div class="flex flex-col md:flex-row gap-2 sm:ml-auto">
            <button class="btn w-full md:w-auto btn-neutral" @click="newsStore.prevPage"
                :disabled="newsStore.meta.page === 0 || newsStore.meta.page === 1">
                <font-awesome-icon icon="fa-solid fa-arrow-left" />
            </button>

            <button class="btn w-full md:w-auto btn-neutral" @click="newsStore.nextPage"
