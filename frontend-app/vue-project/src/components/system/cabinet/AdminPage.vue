<template>
  ...
  <div class="flex flex-col lg:flex-row p-5 gap-5">
    ...
    <div
      class="w-full lg:w-1/2 bg-base-200 min-h-50 p-6 lg:p-10 flex flex-col justify-center gap-3"
    >
  ...
  <div class="px-4 sm:px-5 pb-5">
    <div class="flex flex-col w-full bg-base-200 border border-base-300">
      ...
      <div class="flex flex-col xl:flex-row w-full bg-base-100">
        ...
        <div class="flex flex-col sm:flex-row flex-wrap gap-3 p-4 justify-center">
          ...
          <button
            class="btn btn-neutral hover:btn-primary w-full sm:w-auto"
            @click="changeActivityModal = true"
            :class="selectedUserIds.length === 0 ? 'btn-disabled' : ''"
          >
      ...
      >
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:gap-6 w-full sm:w-auto">
          ...
          <div class="flex flex-col sm:flex-row sm:items-center gap-2">
            ...
            <select
              v-model.number="adminStore.meta.limit"
              @change="setNewLimit"
              class="select select-bordered mt-1 sm:mt-0"
              :disabled="adminStore.searchMode === 'id'"
            >
          ...
          <div class="text-sm opacity-80 whitespace-nowrap">
            ...
            <span class="font-semibold">{{ adminStore.meta.total_users }}</span>
          </div>

          <!-- Page info -->
          <div class="text-sm opacity-80 whitespace-nowrap">
            {{ $t('cabinet.admin.table_footer.page') }}
            <span class="font-semibold">{{ adminStore.meta.page }}</span> /
        ...
        <div class="flex flex-col sm:flex-row sm:gap-3 gap-2 w-full sm:w-auto">
          <button
            ...
            :disabled="adminStore.meta.page === 1"
    ...
    <BaseDialog
      v-model="changeActivityModal"
      :title="$t('modals.change_activity.title')"
      :cancel-text="$t('common.cancel')"
      :confirm-text="$t('common.confirm')"
      @confirm="changeActivity"
