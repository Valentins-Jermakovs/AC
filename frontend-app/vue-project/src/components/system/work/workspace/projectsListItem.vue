<template>
  <div
    class="w-full bg-base-100 border border-base-300 rounded-box flex flex-col gap-3 p-4 hover:border-info hover:bg-base-200 transition-all duration-300"
  >
    <!-- Header -->
    ...
    <div class="flex justify-end">
      <button class="btn btn-primary btn-sm gap-2" @click="openProject">
