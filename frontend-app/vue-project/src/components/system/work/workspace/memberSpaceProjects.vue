<template>
    <div v-if="workspaceProjectMembersStore.accessDenied" class="w-full h-full flex items-center justify-center">
    ...
    <div v-else class="flex-1 flex flex-col w-full h-full p-5 gap-2">
        <div class="w-full h-full flex flex-col items-center gap-4 p-4">
            ...
            <div class="w-full bg-base-200 border border-base-300 flex flex-col gap-3 p-1">
                ...
                <div v-if="!workspaceProjectMembersStore.loading && workspaceProjectMembersStore.projectMembers.length === 0"
            ...
            <div class="w-full flex bg-base-200 border border-base-300 px-4 py-2 items-center gap-4">
                <div class="flex-1">
                    <select class="select select-bordered" v-model="workspaceProjectMembersStore.meta.limit"
                ...
                <div class="flex gap-4 text-sm">
                    <p>
                        Total: <span class="font-semibold">{{ workspaceProjectMembersStore.meta.totalItems }}</span>
                    </p>
                    <p>
                        Page:
                        <span class="font-semibold">{{ workspaceProjectMembersStore.meta.page }}/{{
                            workspaceProjectMembersStore.meta.totalPages }}</span>
                    </p>
                </div>

                <div class="flex gap-2 ml-auto">
                    <button class="btn btn-sm btn-neutral" @click="workspaceProjectMembersStore.prevPage"
                        :disabled="workspaceProjectMembersStore.meta.page === 1">
                        <font-awesome-icon icon="fa-solid fa-arrow-left" />
                    </button>
                    <button class="btn btn-sm btn-neutral" @click="workspaceProjectMembersStore.nextPage"
                        :disabled="workspaceProjectMembersStore.meta.page === workspaceProjectMembersStore.meta.totalPages">
...
export default {
    ...
    async mounted() {
        ...
        this.workspaceProjectMembersStore.setProjectId(
            this.workspaceProjectsStore.selectedProject.id
        )
