<template>
  <div class="flex w-full h-full bg-base-200 items-center justify-between p-5 border border-base-300">
    <!-- LEFT: burger + logo -->
    ...
    <!-- RIGHT: buttons -->
    <div class="flex">
      <top-button v-for="(item, index) in navigation" :key="index" :icon="item.icon"
    ...
    <!-- Language Modal -->
    <BaseDialog v-model="languageModal" :title="$t('modals.languages.title')" :cancel-text="$t('common.cancel')">
    ...
    <!-- Support Modal -->
    <BaseDialog v-model="supportModal" :title="$t('common.support')" :cancel-text="$t('common.cancel')">
    ...
    <!-- Logout Modal -->
    <BaseDialog v-model="logoutModal" :title="$t('modals.logout.title')" :confirm-text="$t('common.confirm')"
      :cancel-text="$t('common.cancel')" @confirm="handleLogout">
