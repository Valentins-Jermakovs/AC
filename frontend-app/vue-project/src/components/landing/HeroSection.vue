<template>
  <!--
    Hero Section:
    - Full-screen banner for the landing page
  ...
  >
    ...
    <div class="flex flex-col gap-4 items-center justify-center w-full">
      ...
      <div class="p-5 lg:bg-base-200 lg:w-2/3 h-52 flex items-center justify-center flex-col lg:border-base-300">
        <!-- Main title -->
        ...
        <p class="text-lg lg:text-xl mb-8 text-center max-w-xl text-white lg:text-base-content">
...
<style scoped>
/* Empty style section: all styles are applied via Tailwind CSS */
</style>
