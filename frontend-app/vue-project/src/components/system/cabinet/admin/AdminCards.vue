<template>
  <div class="flex flex-col lg:flex-row p-5 gap-5">
    <!-- Card One -->
    <div
      class="w-full lg:w-1/2 bg-base-200 border border-base-300 min-h-50 p-6 lg:p-10 flex flex-col justify-around"
    >
    ...
    <!-- Card Two -->
    <div
      class="w-full lg:w-1/2 bg-base-200 border border-base-300 min-h-50 p-6 lg:p-10 flex flex-col justify-center gap-3"
    >
