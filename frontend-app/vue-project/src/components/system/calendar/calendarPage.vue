<template>
    <div class="flex flex-col gap-5 p-5">
        ...
        <div class="bg-base-200 border border-base-300 p-3 overflow-x-auto">
            <CalendarHeader :year="currentYear" :month="currentMonth" :months="months" @prev="prevMonth"
                @next="nextMonth">
            </CalendarHeader>

            <CalendarGrid :days="calendarDays" :isToday="isToday" :events="eventsStore.events"
...
export default {
    ...
    async mounted() {
        await this.eventsStore.getEventsByMonth(
            this.currentMonth + 1,
            this.currentYear
        )
    },
