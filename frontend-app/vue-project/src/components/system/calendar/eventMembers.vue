<template>
    ...
    <div class="flex-1 flex flex-col w-full h-full p-3 sm:p-5 gap-3">
        <div class="w-full flex flex-col gap-4">
            ...
            <div class="w-full flex flex-col lg:flex-row gap-3 lg:items-center">
                ...
                <div
                    ...
                    <button class="btn btn-primary w-full sm:w-auto" @click="searchMembers" :disabled="eventParticipantsStore.searchMode !== 'all' &&
            ...
            <div class="w-full bg-base-200 border border-base-300 wrap-break-word p-2 sm:p-3 flex flex-col gap-3">
                <div v-for="member in eventParticipantsStore.participants" :key="member.id"
                    ...
                    <div class="dropdown dropdown-center md:dropdown-end">
                        ...
                        <ul tabindex="0"
                            ...
                            <li>
                                <button class="flex gap-2 text-error"
                ...
                <!-- EMPTY -->
                <div v-if="
                    !eventParticipantsStore.loading &&
                    eventParticipantsStore.participants.length === 0
            ...
            <div
                ...
                <!-- LIMIT -->
                <div>
                    <select class="select select-bordered w-full sm:w-24" v-model="eventParticipantsStore.meta.limit"
                ...
                <div class="flex flex-col md:flex-row gap-2 sm:ml-auto">
                    <button class="btn w-full md:w-auto btn-neutral" @click="eventParticipantsStore.prevPage"
                        :disabled="eventParticipantsStore.meta.page === 1">
                        <font-awesome-icon icon="fa-solid fa-arrow-left" />
                    </button>

                    <button class="btn w-full md:w-auto btn-neutral" @click="eventParticipantsStore.nextPage" :disabled="eventParticipantsStore.meta.page ===
                        eventParticipantsStore.meta.total_pages
                        ">
        ...
        <!-- Add member modal -->
        <base-dialog v-model="addMemberModal" title="Add event member" :confirmText="$t('common.confirm')"
            :cancelText="$t('common.cancel')" @confirm="confirmAddMember" @cancel="closeAddMemberModal">
            <div class="w-full flex flex-col gap-2">
                ...
                <input type="email" class="input w-full" v-model="newMemberEmail"
